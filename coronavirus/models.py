...
class Data(Base):
    ...
    comfirmed = Column(BigInteger, default=0, nullable=False, comment='确诊数量')
    deaths = Column(BigInteger, default=0, nullable=False, comment='确诊数量')
    ...
    def __repr__(self):
        return f'{repr(self.date): 确诊{self.comfirmed}}'
        # return f'{self.country}_{self.province}'
